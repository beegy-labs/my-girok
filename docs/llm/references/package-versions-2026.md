...
> Centralized version tracking for dependency management | **Researched**: 2026-01-22

## Version Summary

### Current vs Latest Stable

| Package           | Current | Latest Stable | Update     | Notes                         |
| ----------------- | ------- | ------------- | ---------- | ----------------------------- |
...
| ClickHouse Client | 1.8.1   | 1.16.0        | ✅ Updated | Official Node.js client       |
...
- ⚠️ MongoDB NOT supported (stay on v6 if using MongoDB)
...
pnpm update vite vitest @vitest/coverage-v8 eslint @nestjs/common @nestjs/core @nestjs/microservices @nestjs/platform-express @nestjs/testing @nestjs/cli
```
