...
> Account types and key decisions | **Version**: 1.0 | **Date**: 2026-01-08

## Purpose

Enterprise-grade authentication system shared across all services (my-girok, vero, future apps).
Common infrastructure enabling rapid onboarding for PoC development without re-implementing auth.
...
| Identity     | `docs/llm/policies/identity-platform.md` |
