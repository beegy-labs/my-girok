...
This document covers advanced GitHub Actions workflow configurations, including optimizations, image management, and troubleshooting procedures.

## Optimizations

### 1. Image Existence Check

Skip builds if image already exists:
...
Efficient caching with cascading restore keys:
...
- Main Workflows: `docs/en/policies/github-actions-workflows.md`

---

_This document is auto-generated from `docs/llm/policies/github-actions-workflows-advanced.md`_
