...
> Microservices architecture with BFF pattern, gRPC internal communication, and polyglot persistence
...
The BFF (Backend for Frontend) pattern provides a GraphQL API for clients while using gRPC for efficient internal communication.

## Identity Platform Structure
...
All PostgreSQL databases share these common functions for consistency.
...
Each service uses the database best suited to its data access patterns.
...
UUIDv7 provides time-sortable unique identifiers per RFC 9562.

---

**LLM Reference**: `docs/llm/architecture.md`
