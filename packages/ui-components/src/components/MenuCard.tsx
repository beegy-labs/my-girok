...
// Fixed height card with flex layout for consistent sizing across languages (V24.5 mockup)
const baseClasses =
...
// Icon container classes (V24.5 mockup: p-6 rounded-3xl)
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-start">
        {/* Icon Container - Left (V24.5: size 32) */}
        <div
      ...
      {/* Content - Bottom aligned (V24.5: mt-12 pr-20) */}
      <div className="mt-12 pr-20">
        <h3
          className="text-3xl text-theme-text-primary mb-4 tracking-tight leading-tight"
      ...
      {/* Hover Arrow - Bottom Right (V24.5: bottom-12 right-12) */}
