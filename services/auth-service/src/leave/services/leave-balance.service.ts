...
export class LeaveBalanceService {
  ...
  private mapToResponse(balance: any): LeaveBalanceResponseDto {
    return {
      ...
      annualPending: parseFloat(balance.annualPending || '0'),
      ...
      compensatoryExpiryDate: balance.compensatoryExpiryDate,
      specialEntitled: parseFloat(balance.specialEntitled || '0'),
      specialUsed: parseFloat(balance.specialUsed || '0'),
      specialRemaining: parseFloat(balance.specialRemaining || '0'),
      carryoverFromPrevious: parseFloat(balance.carryoverFromPrevious || '0'),
