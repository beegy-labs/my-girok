...
Read: `.ai/services/legal-service.md` + `.ai/packages/types.md`
...
- Do NOT include "Generated with Gemini" or similar references
...
- **Read .ai/ for coding** - Patterns, APIs, flows (~2K tokens)
- **Refer to docs/ for policies** - Detailed guides, tutorials (~73K tokens)
