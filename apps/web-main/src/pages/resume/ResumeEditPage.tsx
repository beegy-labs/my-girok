          ...
          <div className={`${showPreview ? 'block' : 'hidden lg:block'}`}>
            <div className="sticky top-4 sm:top-8">
              ...
              <Card variant="secondary" padding="md" className="mb-3 sm:mb-4">
                <h2 className="text-base sm:text-xl font-bold text-theme-text-primary mb-1 sm:mb-2 flex items-center gap-2">
                  <span>👁️</span>
                  {t('edit.livePreview')}
                </h2>
              ...
              {previewData ? (
                <ResumePreviewContainer
                  ...
                  containerClassName="border-2 border-theme-border-default rounded-xl"
                />
              ) : (
                <Card variant="secondary" padding="lg" className="text-center">
                  <p className="text-theme-text-tertiary text-sm sm:text-base">
