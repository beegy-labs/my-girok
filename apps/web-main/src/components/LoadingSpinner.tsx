...
export default function LoadingSpinner({
  ...
  const content = (
    <div className={`flex flex-col items-center justify-center ${className}`}>
      ...
      <p className="mt-6 text-base font-medium text-gray-700 dark:text-dark-text-secondary">
  ...
  if (fullScreen) {
    return (
      <div className="fixed inset-0 flex items-center justify-center bg-gray-50 dark:bg-dark-bg-primary z-50">
        {content}
      </div>
    );
  }
