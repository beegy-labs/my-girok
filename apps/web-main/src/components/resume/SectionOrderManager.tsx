...
function SortableSection({ section }: { section: ResumeSection }) {
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className="bg-theme-bg-elevated border border-theme-border-subtle rounded-input p-4 flex items-center justify-between hover:border-theme-primary transition-colors duration-200"
    >
...
export default function SectionOrderManager({ sections, onReorder }: SectionOrderManagerProps) {
  ...
  return (
    <div className="bg-theme-bg-card border border-theme-border-subtle rounded-input shadow-theme-md p-6 transition-colors duration-200">
      ...
      <div className="mt-4 p-4 bg-theme-status-info-bg border border-theme-status-info-border rounded-input">
