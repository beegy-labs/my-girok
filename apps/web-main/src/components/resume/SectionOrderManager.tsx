...
function SortableSection({ section }: { section: ResumeSection }) {
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className="bg-theme-bg-elevated border border-theme-border-subtle rounded-soft p-4 flex items-center justify-between hover:border-theme-primary transition-colors duration-200"
    >
...
export default function SectionOrderManager({ sections, onReorder }: SectionOrderManagerProps) {
  ...
  return (
    <div className="bg-theme-bg-card border border-theme-border-subtle rounded-soft shadow-theme-md p-6 transition-colors duration-200">
      <div className="mb-4">
