...
> = {
  error: {
    ...
    messageKey: 'status.error.message',
  ...
  'not-found': {
    ...
    messageKey: 'status.notFound.message',
  ...
  expired: {
    ...
    messageKey: 'status.expired.message',
    iconColor: 'text-theme-status-warning-text',
    bgColor: 'bg-theme-status-warning-bg',
  },
  'no-permission': {
    icon: Lock,
    titleKey: 'status.noPermission.title',
    messageKey: 'status.noPermission.message',
    iconColor: 'text-theme-text-tertiary',
    bgColor: 'bg-theme-bg-hover',
  },
  maintenance: {
    ...
    messageKey: 'status.maintenance.message',
    iconColor: 'text-theme-primary',
    bgColor: 'bg-theme-primary/10',
  },
  deleted: {
    icon: Trash2,
    titleKey: 'status.deleted.title',
    messageKey: 'status.deleted.message',
    iconColor: 'text-theme-status-error-text',
    bgColor: 'bg-theme-status-error-bg',
  },
  warning: {
    ...
    messageKey: 'status.warning.message',
    iconColor: 'text-theme-status-warning-text',
    bgColor: 'bg-theme-status-warning-bg',
  },
};
...
export default function StatusMessage({
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <h2 className="text-xl font-bold text-theme-text-primary mb-3 text-center">{displayTitle}</h2>
