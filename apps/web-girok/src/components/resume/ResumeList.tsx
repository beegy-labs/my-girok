  ...
  return (
    <div className="w-full lg:max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <Link
          to="/resume/new"
          className="px-4 py-2 bg-gradient-to-r from-theme-primary-dark to-theme-primary text-white rounded-soft hover:from-theme-primary hover:to-theme-primary-light transition"
        >
      ...
      {resumes.length === 0 ? (
        <div className="text-center py-12">
          ...
          <Link
            to="/resume/new"
            className="inline-block px-6 py-3 bg-gradient-to-r from-theme-primary-dark to-theme-primary text-white rounded-soft hover:from-theme-primary hover:to-theme-primary-light transition"
          >
...
const ResumeCard = memo(function ResumeCard({
  ...
  return (
    <div className="bg-theme-bg-card border border-theme-border-default rounded-soft p-6 hover:shadow-theme-lg transition">
