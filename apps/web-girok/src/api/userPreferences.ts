...
export const getUserPreferences = async (): Promise<UserPreferences> => {
  const response = await personalApi.get<UserPreferences>('/v1/user-preferences');
...
export const upsertUserPreferences = async (
  ...
  const response = await personalApi.post<UserPreferences>('/v1/user-preferences', dto);
  return response.data;
};
...
export const updateUserPreferences = async (
  ...
  const response = await personalApi.put<UserPreferences>('/v1/user-preferences', dto);
  return response.data;
};
