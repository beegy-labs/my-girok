...
const AdminAccountsPage = lazy(() => import('./pages/system/admins/AdminAccountsPage'));
    ...
    children: [
      {
        ...
        children: [
          ...
          // System - Admin Accounts
          {
            path: 'system/admins',
            element: (
              <PrivateRoute permission="system_admin:read">
                <AdminAccountsPage />
              </PrivateRoute>
            ),
          },
          {
            ...
            element: (
              <PrivateRoute permission="system_admin:create">
                <AdminEditPage />
              </PrivateRoute>
            ),
          },
